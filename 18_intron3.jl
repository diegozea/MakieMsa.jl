...
intron3 = join(rand(['A','C','G','T'],48))
## gene_model = "1..50,151..200,301..551"
gene_model = "101..150,251..300,401..651"
dna4 = intron1* dna3[1:50] * intron1 * dna3[51:100] * intron2 * dna3[101:end] * intron3
dna = LongDNA{4}(dna4)
...
dna_width = 3
msa_width = 3
const msa_window = 150
const dna_window = 1*msa_window
const msa_seqs = 20
const font_size = 12
const cell_size = 14
const padding = 200
...
o_plot_dna3!(Axis(f[2,1:dna_width]; yreversed=true,height=80), dna_show, o_dna_pos, color_map = exon_structure_colormap, res_levels = exon_levels ) ## DNA
